...
- [scanners/web_scanner/README.md](/root/swanva/scanners/web_scanner/README.md): placeholder package for future web scanning features
...
- `web_scanner` and `db_scanner` are package placeholders ready for future implementation.
