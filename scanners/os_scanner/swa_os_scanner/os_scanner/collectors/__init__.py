...
from os_scanner.collectors.cron import collect_cron
from os_scanner.collectors.kernel import collect_kernel
from os_scanner.collectors.network import collect_network
from os_scanner.collectors.os_info import collect_os_info
from os_scanner.collectors.packages import collect_packages
from os_scanner.collectors.permissions import collect_permissions
from os_scanner.collectors.services import collect_services
from os_scanner.collectors.software import collect_software
from os_scanner.collectors.sudo import collect_sudo
